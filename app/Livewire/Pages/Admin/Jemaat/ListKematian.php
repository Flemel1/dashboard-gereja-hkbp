...
class ListKematian extends Component
{
    private function getDataForDataTable()
    {
        // Fetch all complaints from the database
        $jemaats = Kematian::select(['id', 'jemaat_id', 'nama_jemaat', 'created_at'])
            ->with(['jemaat'])
        ...
        $formattedData = $jemaats->map(function ($jemaat) {
            ...
            $btnEdit = '<a href="' . route('admin.kematian.edit', $jemaat->id) . '">
    ...
    public function delete($id)
    {
        try {
            ...
            redirect()->route('admin.kematian.list');
        } catch (Exception $ex) {
    ...
    public function render()
    {
        ...
        return view('livewire.pages.admin.jemaat.list-kematian', compact('config'));
    }
}
