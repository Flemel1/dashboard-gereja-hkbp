<div class="card">
    ...
    <div class="card-body">
        <form wire:submit.prevent="update">
            ...
            <x-adminlte-select wire:model.lazy="hari" label="Hari" name="hari" error-key='hari'>
            ...
            <x-adminlte-input wire:model.lazy="jam" label="Jam" name="jam" type="time" error-key='jam'
    ...
    @script
        <script>
            ...
            $wire.on('kegiatan-updated', (event) => {
                const {
                    title,
                    message
                } = event[0];
